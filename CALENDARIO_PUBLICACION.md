...
**Si no hay foto del taller, saltamos el teaser.**
...
4. Piedra del oso de Tito Bustillo (#5).
5. Foto del taller de Domingo.
6. Panel de la gran hornacina (#16).
...
**Etiquetar:** @laesquinadelpeso, @oviedoes, @turismo_asturias, @rtpa, @lne_es.
...
| Hora | Canal | Acción |
|------|-------|--------|
| 10:00 | IG + Bluesky | Post: «Hoy a las 19:30 en La Esquina del Peso. Os esperamos.» |
| 19:30-22:00 | Stories IG | 1-2 stories cada 30 min en directo |
| 23:00 | IG + Bluesky | Post de cierre con 1-2 fotos de la sala |
...
## Hashtags por bloques

**Principales (siempre):** `#ArtePaleolítico #Asturias #Oviedo`

**De la exposición:** `#LaEsquinaDelPeso #CiervaDeLaLluera`

**Generales:** `#ArteRupestre #Grabado #Prehistoria #Patrimonio`

**Geográficos:** `#Asturies #Uviéu #Lena`

**Cuevas:** `#Pindal #TitoBustillo #Candamo #Lluera #Buxu #Llonín #LesPedroses`

**Combinación recomendada por post (máximo 10):**
`#ArtePaleolítico #ArteRupestre #Asturias #Oviedo #LaEsquinaDelPeso #CiervaDeLaLluera #Patrimonio #Grabado #Asturies #Trilineal`

**Recordatorio importante:** los hashtags se ponen en los posts del local, de la prensa y de cuentas aliadas. **En los posts propios de Txomi: sin hashtags**, según su tono natural en Bluesky.
...
## ⚠ Adaptación a la voz de Txomi (importante)

El investigador analizó Bluesky de Domingo (Instagram no es accesible sin login). La voz real de Txomi es **muy informal**: frases cortas, castellano con asturianismos, sin hashtags, sin retórica de galería. Firma como **Txomi**, no como Domingo.

Bio en Bluesky: «Setas, naturaleza, Asturies, arte paleolítico, escultura y grabados prehistóricos».

Si publica él, los textos formales de arriba **chocan** con su tono habitual. Propongo **dos versiones de cada post**:

- **Estándar** (la de arriba) → para los emails a prensa, RTPA y para la cuenta del local (@laesquinadelpeso).
- **Txomi** (la de abajo) → para sus propias cuentas: @txomidelena (IG y Bluesky).

### Versión Txomi · W-3 anuncio
...
> La cierva de la Lluera. La cueva más cerca de casa.
> *(con foto de la pieza #17)*

### Versión Txomi · W-1 víspera

> Mañana abro.

### Versión Txomi · Día D

> Hoy a las 19:30. Os espero.

### Versión Txomi · Después
...
- Castellano natural con asturianismos sueltos si le salen.

---

## Bio y post fijado de Bluesky (durante la expo)

**Bio actual** (Bluesky): «Setas, naturaleza, Asturies, arte paleolítico, escultura y grabados prehistóricos».
...
**Instagram (@txomidelena):** mismo texto, misma foto del cartel. Si Domingo quiere, usar la versión cuadrada (`public/expo/png/logo-cuadrado-instagram.png`) como portada del feed durante la expo.
